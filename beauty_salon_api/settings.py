...
ROOT_URLCONF = 'beauty_salon_api.urls'
...
SIMPLE_JWT = {
    ...
    'BLACKLIST_AFTER_ROTATION': False,  # Отключаем blacklist для упрощения
...
# For development only - allows all origins if DEBUG=True
if DEBUG:
    CORS_ALLOW_ALL_ORIGINS = True

# Additional CORS settings for proper local development
